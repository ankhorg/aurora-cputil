 ...
 * Only the {@link HexUtil#isUpperCase() HexFormat.isUpperCase()} parameter is
 ...
 * {@link HexUtil#toHexDigits(int) toHexDigits(int)} and converted from a string to a
 * primitive value using {@link HexUtil#fromHexDigits(CharSequence) fromHexDigits(string)}.
 * <pre>{@code
...
public final class HexUtil {
     ...
     */
    private static final HexUtil HEX_FORMAT =
            new HexUtil("", "", "", LOWERCASE_DIGITS);
     ...
     */
    private HexUtil(String delimiter, String prefix, String suffix, byte[] digits) {
     ...
     * @return a {@link HexUtil} with the delimiter and lowercase characters
     */
    public static HexUtil ofDelimiter(String delimiter) {
        return new HexUtil(delimiter, "", "", LOWERCASE_DIGITS);
    }
     ...
     */
    public HexUtil withDelimiter(String delimiter) {
        return new HexUtil(delimiter, this.prefix, this.suffix, this.digits);
    }
     ...
     */
    public HexUtil withPrefix(String prefix) {
        return new HexUtil(this.delimiter, prefix, this.suffix, this.digits);
    }
     ...
     */
    public HexUtil withSuffix(String suffix) {
        return new HexUtil(this.delimiter, this.prefix, suffix, this.digits);
    }
     ...
     */
    public HexUtil withUpperCase() {
        return new HexUtil(this.delimiter, this.prefix, this.suffix, UPPERCASE_DIGITS);
    }
     ...
     */
    public HexUtil withLowerCase() {
        return new HexUtil(this.delimiter, this.prefix, this.suffix, LOWERCASE_DIGITS);
    }
    ...
    private static <X extends RuntimeException> int checkFromToIndex(int fromIndex, int toIndex, int length) {
